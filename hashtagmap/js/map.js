...
var mapStyles = [
    ...
    { featureType: 'landscape', stylers: [{ lightness: -90 }, { saturation: -100 }], },
    ...
    { featureType: 'road.local', stylers: [{ lightness: -90 }], },
    { featureType: 'road.arterial', stylers: [{ lightness: -90 }], },
    {
        elementType: 'geometry.stroke',
        featureType: 'road.arterial',
        stylers: [{ visibility: 'on' }],
    },
    { featureType: 'road.highway', stylers: [{ lightness: -70 }], },
    { featureType: 'transit', stylers: [{ visibility: 'off' }], },
    { featureType: 'water', stylers: [{ lightness: -70 }, { saturation: -70 }], },
];
