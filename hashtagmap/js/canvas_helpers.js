var MIN_COLOR = "rgb(50,50,50)";
var MAX_COLOR = "#D0E9C8"
...
function getColor(count) {
    var interpolator = d3.interpolate({colors: [MIN_COLOR]}, {colors: [MAX_COLOR]});
    return interpolator(get_saturation(count)).colors[0];
}
