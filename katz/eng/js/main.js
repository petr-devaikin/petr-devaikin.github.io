...
function setLevel(d) {
    ...
    if (!showAllMode) {
        ...
        levelText2.text('Overall: ' + value2.formatMoney(0, ',', ' '));
        levelAdditionalText2.text('Payments number: ' + count2 + ', average: ' +
    ...
    levelText.text('Overall: ' + value.formatMoney(0, ',', ' '));
    levelAdditionalText.text('Payments number: ' + count + ', average: ' +
